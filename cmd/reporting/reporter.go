...
func Report(final *spf.SPF, topDomain string, spfDomainPrefix string) (TXTRecord, []TXTRecord, error) {
	records := []TXTRecord{}
...
func (r *DNSReport) makeRecords(splits []*spf.SPF) ([]TXTRecord, TXTRecord) {
	records := []TXTRecord{}
